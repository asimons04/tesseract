...
<Modal bind:open={open} icon={Folder} title="Add Community to Group" height="max-h-full" width="max-w-4xl" on:close={() => { history.back() }}>
        ...
        {#if community}
            ...
            <div class="flex flex-col md:flex-row gap-8 w-full">
                ...
                <div class="flex flex-col gap-1 w-full">
                    ...
                    {:else}
                        <Placeholder icon={Folder} title="No Groups" description="This community is not a member of any groups yet." />
                    {/if}
