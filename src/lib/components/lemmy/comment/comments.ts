...
export function buildCommentsTree(comments: CommentView[], baseDepth: number = 0): CommentNodeI[] {
...
export function insertCommentIntoTree(tree: CommentNodeI[], cv: CommentView, parentComment: boolean) {
