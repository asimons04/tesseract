...
<SubNavbar iconSize={28} home back scrollButtons refreshButton toggleCommunitySidebar postActionsMenu communityActionsMenu moderationMenu bind:post={post_view}/>
